...
async function getApplications(status: 'pending' | 'verified' | 'denied') {
...
export default async function PendingApplicationsPage() {
  const applications = await getApplications('pending')

  return <ApplicationsListClient applications={applications} title="Pending Applications" />
}
